...
function Sidebar({ isOpen, onClose }) {
  ...
  // Check if employeeData and user are not null or undefined
  const userName = employeeData && employeeData.user ? employeeData.user.name : 'Guest';
      ...
      >
        ...
        <div className="flex flex-col items-center mb-5 mt-5">
          ...
          <div className="text-center">
            <p className="text-white text-lg font-semibold mt-1">{userName}</p>
