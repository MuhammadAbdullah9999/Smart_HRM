...
const AttendanceCard = ({ Id, Name, Month, Percentage, employeeId }) => {
  return (
    <div className="flex flex-col shadow-md rounded-lg overflow-hidden transition-transform transform hover:scale-105 cursor-pointer hover:shadow-blue-300">
      ...
      <div className="flex flex-col p-4">
        ...
        <p className="text-gray-400 mb-2 text-sm">
          <CalendarMonthIcon className="mr-2 p-1" />
          {Month}
        </p>
        {/* <p className="text-gray-400 mb-2 text-sm">
        ...
        {/* <div className="flex items-center mb-2">
                    ...
                    <p className="text-gray-400 text-sm">{AbsentDays}</p>
                </div> */}
        <div className="flex items-center mb-2">
          <ShowChartIcon className="mr-2 p-1" />
          <p className="text-gray-400 text-sm">{Percentage} %</p>
        </div>
        <Link to={`/dashboard/AttendanceDetail/${employeeId}`}>
